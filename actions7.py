...
class ActionBusinessYearsExplain(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if years==0:
          ...
          dispatcher.utter_message("You have been working in this business for approx {} years, what was it that you were working in, before this venture?".format(years))
          return [SlotSet('counter', counter),FollowupAction("action_listen"),SlotSet('current', current)]
        elif 0<(age-years)<18:
          dispatcher.utter_message("{} years,{} you have been in the business from a very young age, which generationg business is this?".format(years,user_name))
          return [SlotSet('counter', counter),FollowupAction("action_listen"),SlotSet('current', current)]
        elif (age-years)<0:
          dispatcher.utter_message("You cant be working in the business before you were born. Please answer again?".format(user_name))
          return[FollowupAction("action_business_years")]          
...
class ActionFootwear(Action):
    ...
    def run(self, dispatcher, tracker, domain):
      ...
      dispatcher.utter_button_message("What is your nature of business?", buttons)
...
class ActionFootwear3(Action):
      ...
      def run(self, dispatcher, tracker, domain):
        ...
        dispatcher.utter_button_message("Do you have any stock clearance sale?", buttons)
...
class ActionFootwear4(Action):
      ...
      def run(self, dispatcher, tracker, domain):
        ...
        #last_message= tracker.latest_message['text']
        if last_intent=="affirm":
          dispatcher.utter_message("What are the margins during the sale?")
          return [SlotSet('current', current),SlotSet('counter', counter),FollowupAction("action_listen")]
...
class ActionFootwear20(Action):
      ...
      def run(self, dispatcher, tracker, domain):
        ...
        buttons = [{'title': 'Yes', 'payload': 'yes'}, {'title': 'No', 'payload': 'no'}] 
        dispatcher.utter_button_message("Do you manufacture for some fixed clients?", buttons)
...
class ActionFootwear21(Action):
      ...
      def run(self, dispatcher, tracker, domain):
        ...
        #last_message= tracker.latest_message['text']
        if last_intent=="affirm":
          dispatcher.utter_message("Please name them and the business you get from them in a year?")
          return [SlotSet('current', current),SlotSet('counter', counter),FollowupAction("action_listen")]
        
        
        elif last_intent=="deny":
          dispatcher.utter_message("Explain your source of orders!")
          return [SlotSet('current', current),SlotSet('counter', counter),FollowupAction("action_listen")]
