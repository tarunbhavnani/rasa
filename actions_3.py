...
class ActionDefaultFallback(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if last_intent=="greet" and interview_state == "start":
        ...
        if counter=="action_stop" and interview_state == "started":
          return[FollowupAction(counter)]  
        
        if last_intent=="chitchat" and interview_state == "started":
        ...
        if last_intent=="thank" and interview_state == "started":
          dispatcher.utter_template("utter_thanks", tracker)
          return[FollowupAction(current)]
        
        if last_intent=="goodbye" and interview_state == "started":
          dispatcher.utter_message("Goodbye {}".format(user_name))
          counter="action_stop"
          return[FollowupAction(counter)]
        
        if last_intent=="stop" and interview_state == "started":
          dispatcher.utter_message("Goodbye {}".format(user_name))
          counter="action_stop"
          return[FollowupAction(counter)]
